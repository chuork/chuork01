...
|14:25|なるはや Ruby on Rails|[浦嶌啓太](#talk-ursm)|
|14:50|休憩| |
...
浦嶌啓太 ([@ursm](https://github.com/ursm))<br/>
(株)永和システムマネジメント サービスプロバイディング事業部チーフプログラマ。21世紀の開発者のためのグループチャット [Idobata](https://idobata.io) のプロダクトリードを務める傍ら、リンガ泊地にて提督業に勤しんでいる。
{: .profile}
